...
export const numeracy: MentalModel[] = [
  {
    name: 'Permutations and Combinations',
    category: 'Numeracy',
    description: `The mathematics of permutations and combinations leads us to understand the practical probabilities of the world around us, how things can be ordered, and how we should think about things.`,
    author: 'models',
    slug: generateSlug('Permutations and Combinations')
  },
  {
    ...
    author: 'models',
    slug: generateSlug('Algebraic Equivalence')
  },
  {
    name: 'Randomness',
    category: 'Numeracy',
  ...
  },
  {
    ...
    author: 'models',
    slug: generateSlug('Multiplying by Zero')
  },
  {
    name: 'Churn',
    category: 'Numeracy',
