...
export const humanNature: MentalModel[] = [
  {
    name: 'Trust',
  ...
  },
  {
    ...
    author: 'models',
    slug: generateSlug('Bias from Incentives')
  },
  {
    ...
    author: 'models',
    slug: generateSlug('Pavlovian Mere Association')
  },
  {
    ...
    author: 'models',
    slug: generateSlug('Tendency to Feel Envy & Jealousy')
  },
  {
    ...
    author: 'models',
    slug: generateSlug('Tendency to Distort Due to Liking/Loving or Disliking/Hating')
  },
  {
    name: 'Denial',
    category: 'Human Nature & Judgment',
  ...
  },
  {
    ...
    author: 'models',
    slug: generateSlug('Availability Heuristic')
  },
  {
...
Most famously demonstrated by the Linda Test, the same two psychologists showed that students chose more vividly described individuals as more likely to fit into a predefined category than individuals with broader, more inclusive, but less vivid descriptions, even if the vivid example was a mere subset of the more inclusive set. These specific examples are seen as more representative of the category than those with the broader but vaguer descriptions, in violation of logic and probability.`,
    author: 'models',
    slug: generateSlug('Representativeness Heuristic')
  },
  {
    ...
    author: 'models',
    slug: generateSlug('Social Proof (Safety in Numbers)')
  },
  {
    ...
    author: 'models',
    slug: generateSlug('Narrative Instinct')
  },
  {
    ...
    author: 'models',
    slug: generateSlug('Curiosity Instinct')
  },
  {
    ...
    author: 'models',
    slug: generateSlug('Language Instinct')
  },
  {
    ...
    author: 'models',
    slug: generateSlug('First-Conclusion Bias')
  },
  {
    ...
    author: 'models',
    slug: generateSlug('Tendency to Overgeneralize from Small Samples')
  },
  {
    ...
    author: 'models',
    slug: generateSlug('Relative Satisfaction/Misery Tendencies')
  },
  {
    ...
    author: 'models',
    slug: generateSlug('Commitment & Consistency Bias')
  },
  {
    name: 'Hindsight Bias',
    category: 'Human Nature & Judgment',
    ...
    author: 'models',
    slug: generateSlug('Hindsight Bias')
  },
  {
    ...
    author: 'models',
    slug: generateSlug('Sensitivity to Fairness')
  },
  {
  ...
  },
  {
    ...
    author: 'models',
    slug: generateSlug('Influence of Stress (Including Breaking Points)')
  },
  {
    ...
    author: 'models',
    slug: generateSlug('Survivorship Bias')
  },
  {
    name: 'Tendency to Want to Do Something (Fight/Flight, Intervention, Demonstration of Value, etc.)',
    category: 'Human Nature & Judgment',
    description: `We might term this Boredom Syndrome: Most humans have the tendency to need to act, even when their actions are not needed. We also tend to offer solutions even when we do not enough knowledge to solve the problem.`,
    author: 'models',
    slug: generateSlug('Tendency to Want to Do Something (Fight/Flight, Intervention, Demonstration of Value, etc.)')
  },
  {
    name: 'The IKEA',
    category: 'Human Nature & Judgment',
    description: `A cognitive bias in which consumers place a disproportionately high value on products they partially created. The name derives from the name of Swedish manufacturer and furniture retailer IKEA, which sells many furniture products that require assembly.
